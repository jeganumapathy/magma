...
public class BodyTypes extends Box2DTest {
	...
	protected void createWorld(World world) {
...

		{
			...
			PolygonShape shape = new PolygonShape();
			shape.setAsBox(0.5f, 4.0f, new Vector2(4.0f, 0),
					0.5f * (float) Math.PI);
			...
			pjd.initialize(ground, m_platform, new Vector2(0, 5.0f),
					new Vector2(1, 0));
	...
	public void render() {
		...
		// // renderer.batch.drawText(renderer.font,
		// "Keys: (d) dynamic, (s) static, (k) kinematic", 0,
		// Gdx.app.getGraphics()
